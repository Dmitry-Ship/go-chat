...
func NewNotificationEventHandlers(pubsub domain.PubSub, notificationsService NotificationsService, messages readModel.MessageQueryRepository) *notificationEventHandlers {
